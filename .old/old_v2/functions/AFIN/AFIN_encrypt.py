...
def process_arguments():
    ...
    parser = argparse.ArgumentParser(description="Script to perform encryption using the AFIN method")
...
def AFIN_encrypt(N: int, a: int, b: int, number_to_encrypt):
    """
    Function to modify the numbers using the AFIN encrypt method.
...
def main():
    ...
    # Perform encryption
    encrypted_message = AFIN_encrypt(N, a, b, m)
