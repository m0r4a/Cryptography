...
def process_arguments():
    parser = argparse.ArgumentParser(description="Script to decrypt a number encrypted by the AFIN method")
...
def AFIN_decrypt(N, a_inverse, original_b, encrypted_numbers):
    """
    Function to decrypt numbers encrypted by the AFIN method
...
def main():
    ...
    # Decrypt the number
    result = AFIN_decrypt(N, a_inv, original_b, encrypted)
